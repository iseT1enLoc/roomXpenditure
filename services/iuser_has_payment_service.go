...
type UserHasPaymentService interface {
	...
	GetExpenseFromStartDateToEndDate(ctx context.Context, userId, roomId, StartDate, EndDate string, page, limit int) ([]models.UserPaymentResponse, int64, error)
	GetExpenseFromStartDateToEndDateOfOneMember(ctx context.Context, userId, roomId, StartDate, EndDate string, page, limit int) ([]models.UserPaymentResponse, int64, error)
}
